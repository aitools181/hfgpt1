...
Current release: **1.0.16 - Live Search & Auto Filters + v1.0.15 Bug Fixes + v1.0.14 UI Refinement + v1.0.12 Runtime Hardening (Phases 0-7 cumulative)**
...
- v1.0.16 live-search pass: text searches refresh results after a short debounce, select/date filters refresh immediately, and all existing bounded option searches continue to update live without Enter/Search/Apply dependence
