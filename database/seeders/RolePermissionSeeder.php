...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            // Role baselines are explicit and independent. A higher organizational scope does not
            // automatically inherit every operational permission from a lower-scope role.
            $matrix = [
                ...
                'zonal_admin' => array_merge(['view_zone', 'view_center', 'register_family', 'register_karyakar', 'approve_karyakar', 'create_group', 'manage_fixed_families', 'assign_transfer_families', 'assign_area_society', 'view_own_assignments', 'view_reports_analysis', 'view_audit_logs', 'gender_category_filters', 'access_bal_pravruti', 'manage_bal_groups', 'view_bal_analysis', 'manage_family_time', 'view_inventory', 'manage_inventory', 'manage_support', 'manage_correction_requests'], $commonSupport),
